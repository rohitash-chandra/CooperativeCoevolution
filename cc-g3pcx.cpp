...
int main(void)
{
	...
	ofstream out2;
     ...
     for(double x=1;x<=3;x++){ //for the three func optimisation problems
     ...
     //do x number of experiments and calculate mean, confidence interval given the n number of successful runs...
    	...
    	double MeanCycle=0;
    	 ...
    	 double ErrorSum=0;
    	double CycleSum=0;
    	double maxrun =5; //number of experiments for each problem
int success =0;
